...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><span>Enabling Trust and Privacy-Preserving 
      </span>e-KYC System Using Blockchain</a></h1>
            ...
            <form action="fregister" method="post">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your Finanace Name" required>
                </div>
